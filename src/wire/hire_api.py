...
Async:       await wire.hire_async("...")  → WorkforceGraph (rule + LLM fallback)
"""
...
async def hire_async(
    ...
    *,
    ...
    """
    Assemble a workforce with LLM fallback for low-confidence matches.

    Falls back to Claude when rule-based confidence < 0.70.
